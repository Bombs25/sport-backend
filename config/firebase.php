...
if (is_string($firebaseCredentials) && $firebaseCredentials !== '') {
    $isAbsoluteUnixPath = str_starts_with($firebaseCredentials, '/');
    $isAbsoluteWindowsPath = preg_match('/^[A-Za-z]:\\\\/', $firebaseCredentials) === 1;
...
return [
    ...
    'default' => env('FIREBASE_PROJECT', 'osport-71e3c'),
    ...
    'projects' => [
        'app' => $firebaseProjectConfig,
        'osport-71e3c' => $firebaseProjectConfig,
    ],
];
