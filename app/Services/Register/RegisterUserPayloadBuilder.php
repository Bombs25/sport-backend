    ...
    public function build(User $user): array
    {
        ...
        return [
            ...
            'profile' => [
                ...
                'avatar_url' => PublicImageUrl::from($row->avatar_url),
                'is_private' => (bool) $row->is_private,
                'who_can_tag_me' => $row->who_can_tag_me ?? 'everyone',
                'who_can_message_me' => $row->who_can_message_me ?? 'everyone',
                'precise_location_enabled' => isset($row->precise_location_enabled) ? (bool) $row->precise_location_enabled : true,
                'hide_online_status' => isset($row->hide_online_status) ? (bool) $row->hide_online_status : false,
