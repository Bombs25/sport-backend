...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['sometimes', 'nullable', 'string', 'max:32', 'regex:/^\+?[0-9 .\-()]{6,32}$/'],
            'is_private' => ['sometimes', 'boolean'],
            'who_can_tag_me' => ['sometimes', 'string', Rule::in(['everyone', 'followers', 'nobody'])],
            'who_can_message_me' => ['sometimes', 'string', Rule::in(['everyone', 'followers', 'nobody'])],
            'precise_location_enabled' => ['sometimes', 'boolean'],
